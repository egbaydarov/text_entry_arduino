...
void loop()
{
  ...
  MahonyQuaternionUpdate(ax - 666, ay + 60, az, gx * PI / 180.0f, gy * PI / 180.0f, gz * PI / 180.0f, my, mx, mz);
  ...
  if (!AHRS) {
    ...
    if (delt_t > 500) {
      ...
      if (SerialDebug) {
        ...
        Serial.print("X-acceleration: "); Serial.print(1000 * ax - 666); Serial.print(" mg ");
        Serial.print("Y-acceleration: "); Serial.print(1000 * ay + 75); Serial.print(" mg ");
    ...
    if (SerialDebug) {
//      Serial.print(" ax = "); Serial.print((int)1000 * ax - 666);
...
//      Serial.print(" mz = "); Serial.print( (int)mz ); Serial.println(" mG");
      ...
      //      Serial.print(" qz = "); Serial.println(q[3]);
            sprintf(outputBuffer, "%lf %lf %lf %lf %lf %lf %lf %d %d", q[0], q[1], q[2], q[3], ax, ay, az, 0, 0);
